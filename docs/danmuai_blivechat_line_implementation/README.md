...
1. `01_ARCHITECTURE_AND_SCOPE.md`
2. `02_WEB_AND_STYLE_CONTRACT_IMPLEMENTATION.md`
3. `03_QPAINTER_FALLBACK_IMPLEMENTATION.md`
4. `04_TEST_AND_VISUAL_ACCEPTANCE.md`
5. `05_IDE_MASTER_PROMPT.md`
...
- 新增 `blivechat_line` 预设；
- 新增独立布局字段 `floating_panel_layout`；
