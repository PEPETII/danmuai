...
> **历史性能分析快照（2026-06-14）**：本文中的热点、行号和 `app/config_store.py` 单文件结构只对报告生成时有效。现行静态/实测状态见 [CPU 审计](cpu-performance-audit-report.md) 与 [2026-07-10 架构债状态](architecture-debt-wave-status-2026-07-10.md)；未重新 profile 前不得把估算收益称为已确认。
