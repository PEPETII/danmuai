...
1. [PACKAGING_WINDOWS.md](PACKAGING_WINDOWS.md) — 当前 Setup/Portable 发布契约（本文 MSI 方案为历史实验）
2. [RELEASE_ONLINE_VERIFY_AND_ROLLBACK.md](RELEASE_ONLINE_VERIFY_AND_ROLLBACK.md) — 线上验证与回滚
4. [发布报告目录](../../reports/)
