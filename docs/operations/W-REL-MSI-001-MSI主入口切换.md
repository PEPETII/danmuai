...
3. [PACKAGING_WINDOWS.md](PACKAGING_WINDOWS.md)（当前入口；本文仅为 MSI 历史实验）
4. [ai-project-context.md](../../.local-ai/prompts/ai-project-context.md) §10 Windows 发布与应用内更新
...
按 [Codex完成报告模板](../../.local-ai/prompts/templates/Codex完成报告/Codex完成报告模板.md) 输出完整报告。
