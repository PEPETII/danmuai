...
def _build_track_layout(app: object) -> dict[str, object]:
    ...
    return {
        ...
        "layout_mode": normalize_layout_mode(
            app.config.get("layout_mode", "fullscreen")  # type: ignore[union-attr]
        ),
    }
...
class StatusSnapshotBuilder:
    ...
    def build(self) -> dict[str, object]:
        ...
        return {
            ...
            "app_session_danmu_count": state.app_session_danmu_count,
            "app_session_input_tokens": state.app_session_input_tokens,
            "app_session_output_tokens": state.app_session_output_tokens,
