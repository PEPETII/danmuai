...
_CHANGE_KEY_LABELS_EN: dict[str, str] = {
    ...
    "danmu_max_chars": "AI danmu target length",
...
- 单条 AI 生成弹幕过长 → danmu_max_chars（prompt 长度约束，不截断上屏）
- 布局/横竖屏 → layout_mode
...
- AI danmu too long → danmu_max_chars (prompt length target; does not truncate on-screen text)
