...
PETDEX_STATE_SPECS: dict[str, PetDexStateSpec] = {
    ...
    # Builtin yuexin-miao sheet: row 1 art faces left, row 2 faces right (swapped vs PetDex names).
    "running-right": PetDexStateSpec("running-right", 2, 8, 1060),

    "running-left": PetDexStateSpec("running-left", 1, 8, 1060),
...
class PetAssetPack:
    ...
    def frame_rect(self, state: str, frame_index: int) -> tuple[int, int, int, int]:
        ...
        return (col * PET_FRAME_W, spec.row * PET_FRAME_H, PET_FRAME_W, PET_FRAME_H)
