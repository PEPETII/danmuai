...
def register_live2d_routes(
    ...
    @app.post("/api/live2d/open-models-folder")
    @require_auth(check_token)
    def post_live2d_open_models_folder(authorization: str | None = Header(default=None)):
        return invoke_main(live2d_api.open_models_folder, bridge.danmu_app)
